## Dataset conversion from csv to json
Csv to Json Conversion

[![meaningtowords](https://img.shields.io/badge/dbcsvtojson-v1.0-orange)](https://glaciermechanics-metadata-csvtojson1.streamlit.app/) ( Converts CSV to Json )
